...
const QuizQuestionComponent: React.FC<QuizQuestionProps> = ({ question, onAnswer }) => {
  ...
  const handlePlayAudio = () => {
    playPronunciation(question.character.romaji);
  };
    ...
    <div className="bg-dark-800 rounded-2xl p-8 border border-dark-700 max-w-2xl mx-auto">
      <div className="text-center mb-8">
        <div className="text-6xl font-bold text-white mb-4 relative inline-block">
          ...
          <button
            ...
            className="absolute -top-2 -right-12 p-2 bg-accent-500 hover:bg-accent-600 rounded-full text-white transition-colors"
          >
      ...
      <div className="grid grid-cols-2 gap-4">
        {question.options.map((option, index) => {
          ...
          let buttonClass = "p-4 rounded-lg border-2 font-semibold text-lg transition-all duration-200 ";
          ...
          if (showResult) {
            ...
            buttonClass += "bg-dark-700 border-dark-600 text-white hover:border-primary-500 hover:bg-dark-600";
          }
